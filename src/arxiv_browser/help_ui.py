...
HELP_KEY_PAIRS: list[tuple[str, str]] = [
    ...
    ("r / R", "Toggle read / Similar papers"),
...
HELP_DESCRIPTION_OVERRIDES: dict[str, str] = {
    ...
    "train_triage_model": "Train triage model",
    "clear_triage_model": "Clear triage model",
    "triage_model_diagnostics": "Triage model diagnostics",
    "add_to_collection": "Add to collection",
    "debate_paper": "Debate paper",
    "remix_papers": "Paper remix",
    "serendipity": "Surprise me",
    "refresh_conference_deadlines": "Refresh conference deadlines",
    "export_metadata": "Export metadata (JSON)",
    "import_metadata": "Import metadata (JSON)",
...
HELP_PALETTE_ONLY_KEYS: dict[str, str] = {
    ...
    "train_triage_model": "Ctrl+p",
    "clear_triage_model": "Ctrl+p",
    "triage_model_diagnostics": "Ctrl+p",
    "add_to_collection": "Ctrl+p",
    "debate_paper": "Ctrl+p",
    "remix_papers": "Ctrl+p",
    "serendipity": "Ctrl+p",
    "refresh_conference_deadlines": "Ctrl+p",
    "export_metadata": "Ctrl+p",
    "import_metadata": "Ctrl+p",
}
