...
COMMAND_PALETTE_GROUPS: dict[str, str] = {
    ...
    "open_pdf": "Core",
    "preview_pdf": "Core",
    "toggle_focus_pane": "Core",
    "preview_figure": "Research",
    "read_abstract_aloud": "Research",
    "download_pdf": "Core",
    "copy_selected": "Core",
    "toggle_read": "Organize",
    "mark_visible_read": "Organize",
    "schedule_review": "Organize",
    "mark_reviewed": "Organize",
    "clear_review": "Organize",
    "show_due_reviews": "Organize",
...
COMMAND_PALETTE_COMMANDS: list[tuple[str, str, str, str]] = [
    ...
    ("What's New", "Show release notes for this version", "F1", "show_whats_new"),
