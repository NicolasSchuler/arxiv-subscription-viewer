...
from arxiv_browser.widgets.detail_state import DetailRenderState as DetailRenderState
from arxiv_browser.widgets.detail_state import (
    _coerce_detail_state as _coerce_detail_state,
)
from arxiv_browser.widgets.detail_state import (
    _detail_cache_key_for_state as _detail_cache_key_for_state,
)
from arxiv_browser.widgets.detail_state import (
    _normalize_detail_state as _normalize_detail_state,
)
...
def _detail_cache_key(
    ...
    **legacy_kwargs: Any,
    ...
    return _detail_cache_key_for_state(state, glyph_mode=_ACTIVE_DETAIL_GLYPH_MODE)
...
class PaperDetails(Static):
    ...
    def update_state(self, state: DetailRenderState | None) -> None:
        ...
        cache_key = _detail_cache_key_for_state(
            state,
            glyph_mode=_ACTIVE_DETAIL_GLYPH_MODE,
        )
